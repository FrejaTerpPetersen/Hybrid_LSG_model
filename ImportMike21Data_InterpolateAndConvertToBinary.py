...
np.savez('../Managed_Data/Events_data/Binary_Data_Train_Events.npz', HF_events_bin=np.asanyarray(HF_train_events_bin,dtype = "object"),
         LFint_events_bin=np.asanyarray(LF_int_train_events_bin,dtype = "object"), Time=np.asanyarray(HF_train_evt_time,dtype = "object"), 
         Area=np.asanyarray(HF_area,dtype = "object"))

np.savez('../Managed_Data/Events_data/Binary_Data_Val_Events.npz', HF_events_bin=np.asanyarray(HF_val_events_bin,dtype = "object"),
         LFint_events_bin=np.asanyarray(LF_int_val_events_bin,dtype = "object"), Time=np.asanyarray(HF_val_evt_time,dtype = "object"), Area=HF_area)

#Save LF data to use for comparison
np.savez('../Managed_Data/Events_data/Binary_Data_Train_Events_LFmodel.npz', LF_events_bin=np.asanyarray(LF_train_events_bin,dtype = "object"),
         Time=np.asanyarray(HF_train_evt_time,dtype = "object"), Area=LF_area) #timing for LF and HF events are the same.

np.savez('../Managed_Data/Events_data/Binary_Data_Val_Events_LFmodel.npz', LF_events_bin=np.asanyarray(LF_val_events_bin,dtype = "object"),
         Time=np.asanyarray(HF_val_evt_time,dtype = "object"), Area=LF_area) #timing for LF and HF events are the same.
